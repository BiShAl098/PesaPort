    ...
    try {
      ...
      toast.success(
        <div>
          ...
          <p className="text-sm mt-1">Welcome to PesaPort, {fullName || email}!</p>
        </div>,
        {
          position: 'top-right',
          autoClose: 6000,
    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-[#ECEFCA]">
      ...
      <header className="absolute -top-5 left-0 right-0 p-4 md:p-8 flex justify-between items-center z-30">
        <div className="flex items-center gap-3">
          <img src={logoImg} alt="Logo" className="w-25 h-20" />
      ...
      {/* Main Signup Card */}
      <div className="relative z-10 w-full max-w-lg px-0 mt-2">
